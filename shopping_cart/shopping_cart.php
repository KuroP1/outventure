            ...
            <div class="container desktop">
                ...
                <div class="container p-0">
                    <div class="row ml-0 cart-content">
                        <div class="col text-center">
                            <img src="../images/Home/product.png" height="80px" width="80px" alt="product" />
                        </div>
                        <div class="col text-center">
            ...
            <div class="mobile">
                ...
                <div class="cart-content-mobile-container">
                    <div class="cart-content-mobile">
                        <img src="../images/Home/product.png" height="150px" width="150px" alt="product" />
                    ...
                    <div class="location_detail">
                        <div class="location_input">
                            <div class="location_input_content">
                                ...
                                <input class="location_block" type="text" name="address" id="address"
                                    placeholder="Address">
                            </div>
                            <div class="location_input_content">
                                <div class="title">
                                ...
                                <input class="location_floor" type="text" name="address" id="address"
                                    placeholder="Address">
                            </div>
                            <div class="location_input_content">
                                <div class="title">
                                ...
                                <input class="location_room" type="text" name="address" id="address"
                                    placeholder="Address">
                            </div>
                        </div>
                    </div>
