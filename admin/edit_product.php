                            ...
                            <div class="image-column">
                                <?php foreach ($imagePath as $image) { ?>
                                    <div class="image-container">
                                        ...
                                        <!-- handle delete image -->
                                        <a href="/outventure/admin/deleteProductImage.php?image=<?php echo $image; ?>&name=<?php echo $product['ProductName']; ?>&id=<?php echo $productID; ?>&length=<?php echo $imageCount; ?>">Delete</a>
                                    </div>
                                <?php } ?>
                            </div>
                            <div class="row">
