                    ...
                    <div class="product-edit-content">
                        <div class="container">
                            <div class="image-column">
                                <?php foreach ($imagePath as $image) { ?>
                                    <div class="image-container">
                                        ...
                                        <!-- handle delete image -->
                                        <a href="/admin/delete_product_image.php?image=<?php echo $image; ?>&name=<?php echo $product['ProductName']; ?>&id=<?php echo $productID; ?>&length=<?php echo $imageCount; ?>">Delete</a>
                                    </div>
                                <?php } ?>
                            </div>
                            <div class="row">
                            ...
                            <div class='button-section'>
                                ...
                                <a href="/admin/delete_product.php?name=<?php echo $product['ProductName']; ?>" onclick='toProductManage()'>
