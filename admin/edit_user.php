                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-6 pt-3">
                                    <div class='field'>
                                        User ID:
                                        <input class='name-edit-input' type="text" name="id"
                                            value="<?php echo $account["UserID"]; ?>" readonly>
                                        </input>
                                    </div>
                                </div>
                            </div>
                            <div class="row row-cols-2">
                                <div class="col-6">
                                    <div class='field'>
                                        User Name:
                                        <input class='name-edit-input' type="text" name="Username"
                                            value="<?php echo $account["Username"]; ?>">
                                        </input>
                                    </div>
                                    <div class='field'>
                                        User Email:
                                        <input class='name-edit-input' type="text" name="email"
