        ...
        <div class="content" id="content">
            ...
            <div class="product-list-container">
                <div class="product-list-content">
                    <div class="container-fluid table-column">
                        <div class="row">
                        ...
                        if (count($products) > 0) {
                            foreach ($products as $product) {
                                ...
                                <div class='col table-content'>
                                    <a href='/admin/edit_product.php?id=" . $product["ProductID"] . "' onclick='toProductEdit()'>
                                ...
                                <div class='col table-content-2'>
                                    <a href='/admin/delete_product.php?name=" . $product["ProductName"] . "' onclick='toProductManage()'>
                                        <svg width='26' height='26' viewBox='0 0 26 26' fill='none' xmlns='http://www.w3.org/2000/svg'>
