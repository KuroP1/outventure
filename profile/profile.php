        ...
        <div class="sub-navbar">
            <div class="sub-navbar-container">
                ...
                <div class=" sub-navbar-right">
                    ...
                    <a class="cart_icon" href="/outventure/shopping_cart/shopping_cart.php" class="sub-navbar-middle-text">
            ...
            <div class="content-container">
                ...
                <div class="left-container">
                    ...
                    <div id="mobile-menu-container" style="transform: translateX(-100%);">
                        ...
                        <span onclick="MenuDisplay('fp')" id="mobile-menu-text-4" style="background-color: #232323; color: #FFFFFF;">Favourite Product</span>
                    ...
                    <div class="menu-container">
                        ...
                        <span onclick="MenuDisplay('fp')" id="menu-text-4" style="color: #000000;">Favourite Product</span>
                    </div>
                </div>
                ...
                <div class="right-container">
                    <div id="right-container-personal-information" style="display:block;">
                        ...
                        <div class="cards-container">
                            <div class="card">
                                ...
                                <input class='name-input' type="text" name="username" id="name-input" value="<?php echo $row['Username']; ?>" disabled>
                                <!-- <?php
                                        require_once "../config/database.php";
                                        $sql = "SELECT * FROM users WHERE Username ='{$_SESSION['currentUser']}'";
                                        $result = mysqli_query($conn, $sql);
                                        ...
                                        if ($row = mysqli_fetch_assoc($result)) {
                                            echo "<input class='email-text'>{$row['Username']}</input>";
                                        }
                                        ?> -->
                            </div>
                            <div class="card">
                                ...
                                <input class='email-text' id='email-text' value="<?php echo $row['Email']; ?>" disabled>
                                </input>
                                <!--                                 
                                <?php
                                require_once "../config/database.php";
                                ...
                                if ($row = mysqli_fetch_assoc($result)) {
                                    echo "<input class='email-text-edit'>{$row['Email']}</input>";
                                }
                                ?> -->
                            </div>
                        </div>
                        <!-- <button class="edit-button" id='edit-button' onclick="EditProfile()">
                            Edit
                        </button> -->
                    </div>
                    <!-- Order History -->
                    ...
                    <div id="right-container-favourite" style="display:none;">
                        <div class="right-container-top-text">
                            ...
                            <span class="right-container-top-text-sub">Here is you favourite, click and view the product.</span>
                        </div>
                        <div class=".order-history-container">
                            <div class="order-history-card">
                                <table>
                                                ...
                                                if ($resProduct) { // Check if the result is not false
                                                    if (mysqli_num_rows($resProduct) > 0) {
                                                        while ($product = mysqli_fetch_assoc($resProduct)) {
                                                            ...
                                                            echo "
                                                                <tr onclick='GoToProductDetail(" . $product["ProductName"] . ")'>
